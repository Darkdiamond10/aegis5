...
/* 
 * DESACTIVACIÓN GLOBAL TEMPORAL
 * Descomenta la siguiente línea para desactivar todos los chequeos de raíz:
 */
#define AEGIS_DISABLE_AA 1
...
aegis_result_t aegis_aa_full_check(void) {
  ...
  /* 
   * =====================================================================
   * DESACTIVACIÓN TEMPORAL: Retornamos siempre OK ignorando los chequeos
   * =====================================================================
   */
  return AEGIS_OK;

  /* --- BLOQUE COMENTADO PARA EVITAR ANÁLISIS ---
  aegis_result_t rc;
